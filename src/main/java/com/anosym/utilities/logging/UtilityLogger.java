 ...
 */
package com.anosym.utilities.logging;
...
public final class UtilityLogger {
  ...
  private static final Logger LOG = Logger.getLogger(UtilityLogger.class.getName());
  ...
  public static synchronized void addHandler(Handler handler) throws SecurityException {
